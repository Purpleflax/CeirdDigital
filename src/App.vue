  ...
  <div class="page">
    <header class="site-header">
      <div class="container nav">
        ...
        <div class="nav-cta">
          <RouterLink class="btn ghost" to="/#work">View work</RouterLink>
          <RouterLink class="btn primary" to="/#contact">Start a project</RouterLink>
        </div>
      </div>
    </header>
